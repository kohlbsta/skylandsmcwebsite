            ...
            <div className="mb-4">
              ...
              <div className="flex items-center justify-center gap-2 text-blue-100 text-sm">
                ...
                <button
                  ...
                  className="text-yellow-300 hover:text-yellow-200 font-mono font-semibold transition-colors duration-200 hover:underline cursor-pointer flex items-center gap-1"
